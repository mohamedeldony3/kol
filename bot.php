      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/N9JN9j/2",
                   'caption'=>'𝒘𝒆𝒍𝒍𝒄𝒐𝒎𝒆 𝒊𝒏 𝒃𝒐𝒕 𝒉𝒖𝒏𝒕𝒆𝒓 𝒃𝒚- ＭＡＲＯ 🍻',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'𝗔𝗗𝗗 𝗔𝗖𝗖𝗢𝗨𝗡𝗧 𝗙𝗔𝗞𝗘🌿','callback_data'=>'login']],
                          [['text'=>"شرح للبوت 👑",  'url'=>"https://t.me/YXUYT/3"]],
                      ]
                  ])
              ]); 
...
لمراسه المطور - @MA_RO1",
                  'reply_markup'=>json_encode([
					...
					$bot->sendphoto([
							'chat_id'=>$chatId,
							'photo'=> "https://t.me/MA_RO1/16",
							 'caption'=>'البوت مدفوع 💲 و ليس مجاني 👁‍🗨
لشراء نسخه مراسلةة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| 『 𓆰⌯𝐌𝗮𝗥𝗢 』','url'=>'t.me/MA_RO1']],
                          [['text'=>"▪️| 𓆰 ＨＵＮＴＥＲ ℡ᴖ̈💜✨⋮", 'url'=>"t.me/FHHUNTER"]],
                      ]
                  ])
              ]);   
				}
